...
const SEED_STOPWORDS = [
  "a", "an", "the", "and", "or", "but", "no", "not", "yes", "we", "i", "you", "he",
  "she", "it", "they", "on", "in", "at", "to", "of", "for", "is", "are", "was", "be",
  "do", "did", "so", "if", "as", "my", "me", "up", "us", "am", "by", "ok",
  "e", "ou", "o", "os", "as", "um", "uma", "de", "da", "do", "na", "no", "em", "eu",
  "tu", "ele", "ela", "nao", "não", "sim", "que", "se", "com", "por", "pra", "ja", "já",
];
...
export async function up(knex) {
  ...
  await knex("stopwords").insert([...new Set(SEED_STOPWORDS)].map((word) => ({ word })));
}
